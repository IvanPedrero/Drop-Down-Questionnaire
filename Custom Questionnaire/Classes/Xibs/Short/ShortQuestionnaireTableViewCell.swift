//
//  ShortAnswerQuestionnaireTableViewCell.swift
...
class ShortQuestionnaireTableViewCell: UITableViewCell {
    ...
    private func saveData() {
        ...
        let answer = ShortAnswer(questionTitle: self.questionTitle.text!, answer: answerTextField.text!)
        self.questionnaireView.saveAnswer(index: questionnaireIndex, answer: answer)
        
        changeAnsweredIndicator(answered: true)
    }
    
    public func updateSavedData(answer: ShortAnswer) {
